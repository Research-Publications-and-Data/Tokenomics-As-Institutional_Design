...
| **Subsidy ratio** | Derived | `token_incentives / (revenue + token_incentives)` |
...
|----------|---------------|------------------------|---------------|-------------|
| MakerDAO | $790.4M | $0.0M | **0.0%** | 0.045 |
| Aave | $254.1M | $149.1M | **37.0%** | 0.020 |
| Compound | $23.0M | $36.5M | **61.4%** | 0.027 |
| Curve | $92.7M | $277.7M | **75.0%** | 0.171 |
...
# Subsidy ratio: incentives / (revenue + incentives)
# Protocols with revenue ≈ 0 (Uniswap) are excluded
df["subsidy_ratio"] = df["incentives_annual_usd"] / (
    df["revenue_annual_usd"] + df["incentives_annual_usd"]
)

# Flag Uniswap (fee switch inactive)
