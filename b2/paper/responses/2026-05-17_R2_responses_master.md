...
- **Section 4.1 (publicity-territory list)**: CRV removed from the upper-end-of-distribution territory list (which is now Aethir 0.087, Livepeer 0.199, WeatherXM 0.148). The veCRV discussion is reserved for the Section 4.1 ve-locking paragraph.
