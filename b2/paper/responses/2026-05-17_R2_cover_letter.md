...
- **Subsidy multivariate with sector control** (Section 3.7): A multivariate OLS specification with both subsidy ratio and DePIN sector dummy on the 22-protocol non-zero-subsidy sample (HC3 robust standard errors) demonstrates that the apparent subsidy-HHI relationship is fully absorbed by DePIN sector membership once Livepeer is excluded. Specification 4 (subsidy + DePIN dummy, no Livepeer, N = 21): subsidy coefficient becomes non-significant (p = 0.56) while DePIN sector dummy remains significant (p = 0.03). The Livepeer-driven interpretation in Section 3.4 is substantively reinforced: the apparent cross-sector subsidy-concentration association reflects a single extreme observation combined with sector membership, not a structural relationship between subsidy intensity and governance concentration.

- **Aethir top-holder verification + 8-PCA cascade** (Section 4.8 footnote; exclusions_log.csv): Web-verification cycle (2026-05-19) of the next four unlabeled Aethir top holders identified one confirmed additional PCA (0xfc78 is a Safe 1.4.1 multisig with Exec Transaction pattern matching the previously-documented 0x3e7e Class 2 typology). Adding 0xfc78 to the canonical exclusion set raised the documented PCA count from 7 to 8 and shifted Aethir HHI from 0.087 to 0.095. The cascade through dependent statistics is small: DePIN sector mean shifts from 0.077 to 0.078; Mann-Whitney p shifts to 0.020 (preserved at p<0.05); Cohen's d 0.94 (still large effect by Cohen's threshold); LOO 30 of 30 significant preserved. Three additional top holders (0x33548 distribution-wallet, 0x5a4a strategic-allocation candidate, 0xaf8d indeterminate large EOA) verified but not excluded pending inter-rater reliability cycle.

- **Universal-audit cascade for IoTeX + ENS missed exclusions** (Section 4.8 footnote; exclusions_log.csv): The 2026-05-19 universal verification cycle identified two missed exclusions consistent with already-applied PCA typologies: (i) IoTeX Genesis-burn precompile slots 0x03 (1B IOTX) and 0x07 (748M IOTX) had been omitted despite matching the Class 1 pattern already applied to slots 0x01, 0x02, 0x04, 0x05, 0x06; adding both shifted IoTeX HHI from 0.189 to 0.081. (ii) ENS Cold Wallet 0x690f0581 (4.29M ENS, Etherscan-labeled Safe Singleton 1.3.0 multisig created by nick.eth) had not been excluded despite Class 2 typology; adding it shifted ENS HHI from 0.071 to 0.049. The cascade through dependent statistics is contained: DePIN sector mean shifts from 0.078 to 0.071; DePIN-vs-DeFi Mann-Whitney significance preserved (p = 0.020 vs prior 0.018); LOO 30 of 30 significant-iteration robustness preserved. The Synergy-HHI Pearson correlation remains statistically significant (r = -0.32, p = 0.047). All headline findings qualitatively preserved.
