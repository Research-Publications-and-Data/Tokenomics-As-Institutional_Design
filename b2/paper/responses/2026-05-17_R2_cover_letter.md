...
- **Synergy Index full-sample expansion** (Section 3.7; Supplementary File S3): The original scoring rubric was applied at the five-lens summary level to the remaining 28 protocols in the cross-section, producing Synergy Index values for all 40 protocols (full-sample arithmetic Synergy-vs-HHI Spearman rho = -0.25, p = 0.12; geometric Synergy-vs-HHI Spearman rho = -0.20, p = 0.22; arith-vs-geom rank agreement rho = 0.98 on the 40-protocol sample). This addresses the partial-coverage limitation noted in the R1 round of reviews and provides an operationalization-robustness result on the aggregation-choice question: the rank ordering is preserved across both arithmetic-mean and geometric-mean aggregations at scale. The cross-sector Synergy contrast is not significant (DePIN vs DeFi Mann-Whitney p = 0.30), indicating that the HHI sector-signal does not translate symmetrically to the institutional-design Synergy dimension, a substantive new finding for the framework's discriminating power. Filecoin (1.95), Optimism (1.90), and Gitcoin (1.90) sit at the top of the full-sample distribution; Aethir (0.90) sits at the bottom.

- **Operationalization-dependency caveat** (Section 4.8): Explicit acknowledgment that the framework's empirical conclusions depend on operationalization choices; alternative scoring criteria for the same lens could yield different lens scores. The Synergy Index full-sample expansion (above) addresses the lens-aggregation choice question at the rank-ordering level.
