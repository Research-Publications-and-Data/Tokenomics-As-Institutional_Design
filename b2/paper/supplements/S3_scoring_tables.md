...
Note: the 28-protocol lens means below are derived from the per-criterion 20-cell scoring in `S3_scoring_tables_20cell_extension_2026-05-19.md` following the web-verification cycle 2026-05-19 (verification sources documented per protocol in the extension file).

| Protocol | Category | HHI | Publicity | Fairness | Non-Dom. | Polycentric | Knowledge | Syn. (arith) | Syn. (geom) |
|----------|----------|-----|-----------|----------|----------|-------------|-----------|--------------|-------------|
| Filecoin | DePIN | 0.022 | 2.50 | 1.25 | 2.00 | 2.50 | 2.00 | 2.05 | 1.99 |
| Gitcoin | Social_Dead | 0.022 | 2.25 | 2.25 | 1.75 | 2.00 | 1.50 | 1.95 | 1.93 |
| Optimism | L1_L2_Infra | 0.009 | 2.25 | 1.75 | 2.25 | 2.00 | 1.25 | 1.90 | 1.86 |
| Helium | DePIN | 0.074 | 2.00 | 1.00 | 2.00 | 2.00 | 2.00 | 1.80 | 1.74 |
| The Graph | L1_L2_Infra | 0.033 | 2.25 | 1.50 | 1.75 | 2.00 | 1.50 | 1.80 | 1.78 |
| Rocket Pool | DeFi | 0.039 | 2.50 | 1.50 | 1.75 | 2.00 | 1.00 | 1.75 | 1.67 |
| Arbitrum | L1_L2_Infra | 0.012 | 2.00 | 1.50 | 2.00 | 1.75 | 1.25 | 1.70 | 1.67 |
| Aave | DeFi | 0.013 | 2.25 | 1.50 | 2.00 | 1.25 | 1.25 | 1.65 | 1.60 |
| MetaDAO | DeFi | 0.015 | 2.00 | 1.00 | 2.25 | 0.50 | 2.50 | 1.65 | 1.41 |
| MakerDAO | DeFi | 0.040 | 2.00 | 0.75 | 1.75 | 2.00 | 1.50 | 1.60 | 1.51 |
| Balancer | DeFi | 0.029 | 2.00 | 1.00 | 1.50 | 1.50 | 2.00 | 1.60 | 1.55 |
| Token Engineering Commons | Social_Dead | 0.028 | 2.00 | 1.50 | 1.50 | 1.50 | 1.50 | 1.60 | 1.59 |
| Polygon | L1_L2_Infra | 0.035 | 2.25 | 1.25 | 1.75 | 1.50 | 1.00 | 1.55 | 1.49 |
| Pokt Network | DePIN | 0.090 | 2.25 | 1.00 | 1.50 | 1.50 | 1.50 | 1.55 | 1.50 |
| Hivemapper | DePIN | 0.018 | 1.50 | 1.50 | 1.25 | 1.00 | 2.50 | 1.55 | 1.48 |
| DIMO | DePIN | 0.025 | 1.50 | 1.25 | 1.75 | 1.50 | 1.50 | 1.50 | 1.49 |
| Curve | DeFi | 0.014 | 2.00 | 0.75 | 1.25 | 1.50 | 2.00 | 1.50 | 1.41 |
| Drift | DeFi | 0.053 | 1.75 | 1.00 | 1.50 | 1.75 | 1.50 | 1.50 | 1.47 |
| Wormhole | L1_L2_Infra | 0.012 | 2.25 | 1.00 | 1.75 | 1.50 | 1.00 | 1.50 | 1.43 |
...
| WeatherXM | DePIN | 0.148 | 1.50 | 1.00 | 1.25 | 1.25 | 2.00 | 1.40 | 1.36 |
| Axelar | L1_L2_Infra | 0.027 | 2.25 | 1.00 | 1.50 | 1.25 | 1.00 | 1.40 | 1.33 |
| ENS | L1_L2_Infra | 0.049 | 1.75 | 1.00 | 1.75 | 1.25 | 1.00 | 1.35 | 1.31 |
| LayerZero | L1_L2_Infra | 0.014 | 1.75 | 1.00 | 1.50 | 1.25 | 1.25 | 1.35 | 1.33 |
| Hyperliquid | DeFi | 0.005 | 2.00 | 1.00 | 1.50 | 0.00 | 2.00 | 1.30 | 0.57 |
| IoTeX | DePIN | 0.081 | 1.75 | 0.75 | 1.00 | 1.50 | 1.50 | 1.30 | 1.24 |
| Livepeer | DePIN | 0.199 | 1.50 | 1.00 | 1.00 | 1.00 | 2.00 | 1.30 | 1.25 |
| Morpheus AI | DePIN | 0.046 | 1.50 | 1.00 | 1.25 | 1.25 | 1.50 | 1.30 | 1.29 |
| Maple Finance | DeFi | 0.024 | 1.75 | 1.00 | 1.50 | 1.00 | 1.00 | 1.25 | 1.21 |
| Render | DePIN | 0.027 | 1.50 | 1.00 | 1.25 | 1.00 | 1.50 | 1.25 | 1.23 |
| Ether.Fi | DeFi | 0.042 | 1.75 | 1.00 | 1.00 | 1.00 | 1.00 | 1.15 | 1.12 |
| Grass | DePIN | 0.035 | 1.50 | 1.00 | 1.25 | 0.50 | 1.50 | 1.15 | 1.07 |
| Aethir | DePIN | 0.095 | 1.50 | 0.50 | 1.25 | 1.00 | 1.50 | 1.15 | 1.07 |
| Jupiter | DeFi | 0.096 | 1.50 | 0.75 | 1.25 | 1.00 | 1.00 | 1.10 | 1.07 |
| io.net | DePIN | 0.125 | 1.00 | 1.00 | 1.25 | 0.50 | 1.50 | 1.05 | 0.99 |
...
- **Synergy (arith) vs HHI:** Spearman rho = -0.284 (p = 0.076); Pearson r = -0.319 (p = 0.045, statistically significant at conventional alpha). Direction: higher concentration predicts lower institutional-design quality across the five lenses.
- **Synergy (geom) vs HHI:** Spearman rho = -0.229 (p = 0.155). Weakest-link aggregation preserves the negative direction at attenuated magnitude.
- **Arith vs geom Synergy:** Spearman rho = 0.974 (p < 0.001) on rank ordering. Operationalization-of-aggregation choice does not materially change protocol rank ordering across the 40-protocol sample, addressing one operationalization-dependency concern raised in Section 4.8.
- **Sector mean Synergy:** DeFi 1.45 (N = 15); DePIN 1.38 (N = 15); L1_L2_Infra 1.57 (N = 8); Social_Dead 1.77 (N = 2). DePIN-vs-DeFi Synergy contrast: Mann-Whitney U = 86, p = 0.279 (not significant; sector signal in HHI does not translate symmetrically to Synergy Index, indicating that the five-lens framework captures dimensions orthogonal to raw holding concentration).
...
## 13 to 40. Extended-sample per-criterion 20-cell scoring (added 2026-05-19)

The 28 protocols documented in the summary table above carry full per-criterion 20-cell scoring with web-verified evidence per cell, documented in the companion file `S3_scoring_tables_20cell_extension_2026-05-19.md` (560 cells across 28 protocols). This file includes:

- Per-criterion (PUB-1 through KNOW-4) score (0 to 3) with brief evidence note per cell.
- Verification sources per protocol (governance documentation URLs, proposal-type names, multi-sig structures, voting-mechanism details cross-referenced against official protocol docs as of 2026-05-19).
- Per-lens means recomputed from per-criterion scores (the summary table above shows these recomputed values).
- Per-protocol arithmetic-mean and geometric-mean Synergy Index values.

Methodology: NDOM-2 (concentration limit) follows the original 11 anchors' empirical convention (HHI less than 0.05 -> score 2 "partial" rather than the strict S2 rubric's 3 "exemplary"), reflecting that low holding HHI is consistent with but does not establish exemplary concentration limits absent voting-layer evidence (Section 3.5 documents universal delegation amplification). Other criteria are scored from web-verified evidence per the verification cycle 2026-05-19.

Single coder (ZZ); inter-rater reliability deferred to future cycles per S2 reliability protocol.

Reproducibility scripts:
- `synergy_index_full_sample_2026-05-19.py`: full 40-protocol Synergy Index computation + statistical analysis
- `generate_28_protocol_20cell_scoring.py`: per-criterion 20-cell scoring + evidence-note generator
- `power_indices_2026-05-19.py`: Shapley-Shubik power-index computation for Tally voting-layer subsample
- `subsidy_multivariate_2026-05-19.py`: subsidy multivariate OLS with DePIN sector control
