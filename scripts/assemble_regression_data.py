...
gov = pd.read_csv(PROJECT_DIR / "governance_concentration_april2026.csv")
print(f"governance_concentration: {len(gov)} protocols")

cov = pd.read_csv(DATA_DIR / "covariates_merged.csv")
...
out_path = PROJECT_DIR / "regression_data_april2026.csv"
